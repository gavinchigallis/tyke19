...
@section('title', 'The Tech Store &reg; | Home')
...
<!--banner-->
	<div class="banner-w3">
			...
			<link href="<?php echo Config::get('constants.BASE_URL'); ?>vendors/coreSlider/css/coreSlider.css" rel="stylesheet" type="text/css">
			<script src="<?php echo Config::get('constants.BASE_URL'); ?>vendors/coreSlider/js/coreSlider.js"></script>
			<script>
			$('#example1').coreSlider({
			  pauseOnHover: false,
			  interval: 3000,
...
<!--content-->
	<div class="content">
				...
				<div class="new-arrivals-w3agile">
					<div class="container">
						...
						<div class="arrivals-grids">
							<div class="col-md-3 arrival-grid simpleCart_shelfItem" ng-repeat="product in featured_products">
								<div class="grid-arr">
										...
										<figure>		
											<a href="product/1">
												<div class="grid-img">
													...
													<img ng-src="../storage/app/public/images/@{{product.image}}" class="img-responsive" on-error-src="images/no_image_available.jpeg"/>
												</div>
												<div class="grid-img">
													<!--img  src="images/p28.jpg" class="img-responsive" alt=""-->
													<img ng-src="../storage/app/public/images/@{{product.image}}" class="img-responsive" on-error-src="images/no_image_available.jpeg"/>
									...
									<div class="women">
										...
										<p ><del>$@{{product.price}}</del><em class="item_price">$@{{(product.price * (100 - product.Sale.discount)) / 100}}</em></p>
			...
			<!--new-arrivals-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<h2 class="tittle">On Sale</h2>
						<div class="arrivals-grids">
							<div class="col-md-3 arrival-grid simpleCart_shelfItem" ng-repeat="product in products_on_sale">
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<!--img  src="images/p28.jpg" class="img-responsive" alt=""-->
													<img ng-src="@{{product.image}}" class="img-responsive" on-error-src="images/no_image_available.jpeg"/>
												</div>
												<div class="grid-img">
													<!--img  src="images/p28.jpg" class="img-responsive" alt=""-->
													<img ng-src="@{{product.image}}" class="img-responsive" on-error-src="images/no_image_available.jpeg"/>
